...
> **Warning:** The published Yield/Day metrics only include reward payments versus order volumes. They _do not_ capture the individual miner's profit or loss on the underlying strategy or any transaction fees (if any) that generated the orders created. As a result, _liquidity mining yields are not an indication of a miner's overall portfolio return_; miners should take into consideration overall economics, and not just mining return, when deciding on participating in liquidity mining campaigns.
