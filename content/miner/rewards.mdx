...
To know more about your payouts, click **Payouts** tab. For details, see [Payout](payouts)
...
To know more on how the rewards are calculated, see [Liquidity mining rewards calculation](/faq/liquidity-mining)
